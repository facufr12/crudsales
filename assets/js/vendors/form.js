...
document.getElementById('estado_civil').addEventListener('change', function() {
  if (this.value === 'Casado' || this.value === 'Concubinato') {
    ...
    document.getElementById('categoria_monotributo_esposa_section').style.display = 'none';
...
document.getElementById('tipo_contratacion').addEventListener('change', function() {
  if (this.value === 'Monotributo') {
    document.getElementById('categoria_monotributo_section').style.display = 'block';
  } else {
    document.getElementById('categoria_monotributo_section').style.display = 'none';
...
document.getElementById('tipo_contratacion_esposa').addEventListener('change', function() {
  if (this.value === 'Monotributo') {
    document.getElementById('categoria_monotributo_esposa_section').style.display = 'block';
  } else {
    document.getElementById('categoria_monotributo_esposa_section').style.display = 'none';
    document.getElementById('categoria_monotributo_esposa').value = '';
  }
...
document.getElementById('hijos_si').addEventListener('click', function() {
  ...
  document.getElementById('cantidad_hijos').addEventListener('input', function() {
    ...
    for (var i = 0; i < cantidad; i++) {
      edadesHtml += '<label for="edad_hijo_' + (i + 1) + '">Edad del hijo ' + (i + 1) + ':</label><br>';
      edadesHtml += '<input type="number" id="edad_hijo_' + (i + 1) + '" name="edad_hijo_' + (i + 1) + '" required><br><br>';
    }
...
document.getElementById("formulariooo").addEventListener('submit', function(event) {
  ...
  const jsonData = {
    ...
    "numberSons": parseInt(document.getElementById("cantidad_hijos").value) || null,
